...
def jobs() -> list[dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "deliver": "local",
            "skills": [RESEARCH_SKILL],
            "enabled_toolsets": ["x_search", "web", "file"],
            **a,
            "prompt": """You are the X/Twitter scout for the Unknown Frontier AI lane. Search recent low-engagement technical posts from builders, researchers, maintainers, small labs, and tool authors. Hunt for code, demos, patches, benchmarks, unusual techniques, agent workflows, wrappers, model/inference findings, and early capabilities that have not reached mainstream AI discussion. Do not optimize for viral posts. If ~/.local/state/vesper/research/frontier-discovery-seeds.json exists, treat its xQueries as optional learned expansion hints, never as an allowlist; reserve meaningful budget for completely new searches every run. Expand from good authors into replies, quoted posts, linked repositories, and neighboring accounts. Verify strong claims through primary code/docs when possible. Return 5-12 findings maximum with post URL, engagement context, primary source, what is new/useful, evidence, confidence, and why it may have been missed.""",
        },
        {
            "name": "Free AI Radar",
            "schedule": "55 8 * * *",
        ...
        },
        {
            ...
            "deliver": "local",
            "skills": [RESEARCH_SKILL],
            "enabled_toolsets": ["web", "x_search", "file"],
            **a,
