...
machine-readable JSON. The Qt/QML shell consumes that command after a short
debounce and renders compact result rows; detail, install and reconciliation
flows remain separate work.
